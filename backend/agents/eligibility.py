...
class EligibilityAgent(Agent):
    ...
    system_prompt = (
        ...
        "Dikkat: en üstteki genel 'state' alanı (full/partial/locked) ile her "
        "koşulun kendi 'state' alanı (met/action/unmet) FARKLI değer kümeleridir "
        "— birini diğerinin yerine yazma.\n\n"
